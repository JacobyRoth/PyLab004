...
draw_pumpkin(t, 0, -300, 50)  # Draw the pumpkin
draw_eye(t, -40, -250, 20)  # Left eye
draw_eye(t, 25, -250, 20)   # Right eye
draw_mouth(t, -40, -270, 35)  # Mouth

draw_pumpkin(t, -150, -300, 60)  # Draw the pumpkin
draw_eye(t, -190, -240, 25)  # Left eye
draw_eye(t, -130, -240, 25)   # Right eye
draw_mouth(t, -190, -270, 40)  # Mouth

draw_pumpkin(t, 150, -300, 75)  # Draw the pumpkin
draw_eye(t, 100, -200, 30)  # Left eye
draw_eye(t, 175, -200, 30)   # Right eye
draw_mouth(t, 100, -265, 50)  # Mouth
